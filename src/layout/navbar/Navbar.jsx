			...
			<div className="container">
				<div className="d-flex navbar-collapse justify-content-center">
					<ul className="navbar__menu ">
						...
						<li className="nav-item"><Link to="/posts"><MDBBtn onClick={() => filterHandler('post')} className={classActive === 'post' ? 'btn btn-success active' : 'btn btn-success'}>Статьи</MDBBtn></Link></li>
